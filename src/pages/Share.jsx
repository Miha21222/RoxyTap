    ...
    return (
        <div className="flex">
            ...
            <div className="flex items-center justify-center -mt-32">
                <img src="./img/roxy.png" alt="boxy" className="scale-110" />
            </div>
            <div className="flex p-5 gap-3 justify-center items-center w-screen fixed left-0 top-[31rem] bg-black bg-opacity-60 border-b-2 border-t-2 border-purple-700 border-dashed">
