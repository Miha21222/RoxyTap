...
const Links = () => {
    return (
        <>
            ...
            <div className="flex flex-col justify-center items-center w-screen fixed left-0 top-52 bg-black bg-opacity-30 border-b-2 border-t-2 border-purple-700 border-dotted">
            ...
            <div className="flex flex-col justify-center items-center w-screen fixed left-0 top-[21rem] bg-black bg-opacity-30 border-b-2 border-t-2 border-purple-700 border-dotted">
            ...
            <div className="flex flex-col justify-center items-center w-screen fixed left-0 top-[29rem] bg-black bg-opacity-30 border-b-2 border-t-2 border-purple-700 border-dotted">
