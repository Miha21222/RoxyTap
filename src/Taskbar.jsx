...
const Taskbar = () => {
    ...
    return (
        <>
            <div className="bg-black flex w-screen justify-between border-t-4 border-purple-700 border-dashed">
                <button className="bg-transparent" id="link"><NavLink to='/home' className={(navData) => (navData.isActive ? 'active' : 'text-white')}><BiSolidJoystick className="active:text-green-500 active:scale-110 duration-100" size={45} /></NavLink></button>
